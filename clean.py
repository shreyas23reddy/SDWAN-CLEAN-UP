...
if __name__=='__main__':
    ...
    while True:
        ...
        for iter_deviceTemplate in deviceTemplate:
            if iter_deviceTemplate["factoryDefault"] == False and iter_deviceTemplate["devicesAttached"] == 0:
        ...
        for iter_featureTemplate in featureTemplate:
            if iter_featureTemplate["factoryDefault"] == False and iter_featureTemplate["devicesAttached"] == 0:
